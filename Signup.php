								...
								<div class="col-lg-6 col-md-7 position-static p-4">
									<div class="log_wraps">
										...
										<div class="form-group">
											...
											<input type="email" class="form-control" value="" name="Email_Address" required >
										</div>
										...
										<div class="form-group">
										<center><button type="submit" name="Submit2" class="btn btn-primary">Sign Up</button></center>
									</div>
										...
										<div class="form-group text-center mb-0 mt-3">
											Have You Already An Account? <a href="Signin.php" class="theme-cl">LogIn</a>
										</div>
