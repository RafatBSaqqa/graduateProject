...
$File_Name = mysqli_real_escape_string($dbConn,$_POST['File_Name']);



 $file;
move_uploaded_file($_FILES["file"]["tmp_name"], "Lessons_Files/" . $_FILES["file"]["name"]);
      
      $file=$_FILES["file"]["name"];
	  
	$File = 'Lessons_Files/'.$file;
	


$insert = mysqli_query($dbConn,"insert into lessons_files (Lesson_ID,File_Name,File_Path) values ('$Lesson_ID','$File_Name','$File')");
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Add_New_File.php?Lesson_ID=<?php echo $Lesson_ID; ?>&Module_ID=<?php echo $Module_ID; ?>&Course_ID=<?php echo $Course_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
								...
								<input type="hidden" name="Lesson_ID" value="<?php echo $Lesson_ID; ?>"/>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">File Name *</label>
                                    ...
                                    <div class="col-sm-10"><input value="" style="width:450px" type="text" name="File_Name" class="form-control" required></div>
                                </div>
