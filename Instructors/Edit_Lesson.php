...
$sql1 = mysqli_query($dbConn,"select * from lessons where ID='$Lesson_ID'");
...
$sql1 = mysqli_query($dbConn,"update lessons set Title='$Title', Description='$Description' where ID='$Lesson_ID'");

echo "<script language='JavaScript'>
			  alert ('Lesson Information Has Been Updated !');
      </script>";
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Edit_Lesson.php?Lesson_ID=<?php echo $Lesson_ID; ?>&Module_ID=<?php echo $Module_ID; ?>&Course_ID=<?php echo $Course_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
