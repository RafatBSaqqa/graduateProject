...
$insert = mysqli_query($dbConn,"insert into modules (Course_ID,Title,Description) values ('$Course_ID','$Title','$Description')");
...
echo "<script language='JavaScript'>
			  alert ('New Module Has Been Added Successfully !');
      </script>";
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Add_New_Module.php?Course_ID=<?php echo $Course_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
