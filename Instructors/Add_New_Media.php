...
{
$Lesson_ID = mysqli_real_escape_string($dbConn,$_POST['Lesson_ID']);
$Course_ID = mysqli_real_escape_string($dbConn,$_POST['Course_ID']);
$Module_ID = mysqli_real_escape_string($dbConn,$_POST['Module_ID']);
$Media_Name = mysqli_real_escape_string($dbConn,$_POST['Media_Name']);



 $file;
move_uploaded_file($_FILES["file"]["tmp_name"], "Lessons_Media/" . $_FILES["file"]["name"]);
      
      $file=$_FILES["file"]["name"];
	  
	$Media = 'Lessons_Media/'.$file;
	


$insert = mysqli_query($dbConn,"insert into lessons_media (Media_Name,Lesson_ID,Media_Path) values ('$Media_Name','$Lesson_ID','$Media')");
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Add_New_Media.php?Lesson_ID=<?php echo $Lesson_ID; ?>&Module_ID=<?php echo $Module_ID; ?>&Course_ID=<?php echo $Course_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
								...
								<input type="hidden" name="Lesson_ID" value="<?php echo $Lesson_ID; ?>"/>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Media Name *</label>

                                    <div class="col-sm-10"><input value="" style="width:450px" type="text" name="Media_Name" class="form-control" required></div>
                                </div>
