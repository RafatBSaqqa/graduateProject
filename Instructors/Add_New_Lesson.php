...
$insert = mysqli_query($dbConn,"insert into lessons (Module_ID,Course_ID,Title,Description) values ('$Module_ID','$Course_ID','$Title','$Description')");
...
echo "<script language='JavaScript'>
			  alert ('New Lesson Has Been Added Successfully !');
      </script>";

	echo "<script language='JavaScript'>
document.location='View_Module_Lessons.php?Module_ID=".$Module_ID."&Course_ID=".$Course_ID."';
        </script>";
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Add_New_Lesson.php?Module_ID=<?php echo $Module_ID; ?>&Course_ID=<?php echo $Course_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
