...
<body style="back">
    <div id="wrapper">
        ...
        <div class="navbar-header">
         ...
         <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Courses | <a href="Add_New_Question.php?Course_ID=<?php echo $Course_ID; ?>" class="btn btn-primary ">Add New Question</a></h2>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Course Questions List Information </h5>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from questions where Course_ID='$Course_ID' order by ID DESC");
                    ...
                    <tr class="grade">
                        ...
                        <td><?php echo $Wrong_Answer_1; ?></td>
                        <td><?php echo $Wrong_Answer_2; ?></td>
 ...
 <a href="JavaScript:if(confirm('Are You Sure To Delete This Question ?')==true)
{location.replace('Delete_Question.php?Question_ID=<?php echo $Question_ID; ?>&Course_ID=<?php echo $Course_ID; ?>')}" class="btn btn-primary btn-sm" role="button">Delete</a><br>  <a href="Edit_Question.php?Course_ID=<?php echo $Course_ID; ?>&Question_ID=<?php echo $Question_ID; ?>" style="width:52px" class="btn btn-primary btn-sm" role="button">Edit</a></center></td>
 </tr>
