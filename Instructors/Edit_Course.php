...
$sql1 = mysqli_query($dbConn,"select * from courses where ID='$Course_ID'");
...
$sql1 = mysqli_query($dbConn,"update courses set Media_File='$Media_File' where ID='$Course_ID'");
...
$sql1 = mysqli_query($dbConn,"update courses set Title='$Title', Description='$Description', Overview='$Overview', Language='$Language', Price='$Price', Status='$Status' where ID='$Course_ID'");
 ...
 <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Edit_Course.php?Course_ID=<?php echo $Course_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
	...
	<div class="form-group"><label class="col-sm-2 control-label">Description *</label>
								...
								<div class="form-group"><label class="col-sm-2 control-label">Overview</label>
                                    ...
                                    <div class="col-sm-10"><input value="<?php echo $Overview; ?>" style="width:450px" type="text" name="Overview" class="form-control"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
								...
								<div class="form-group"><label class="col-sm-2 control-label">Language</label>
                                    ...
                                    <div class="col-sm-10"><input value="<?php echo $Language; ?>" style="width:450px" type="text" name="Language" class="form-control"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
								...
								<div class="form-group"><label class="col-sm-2 control-label">Price *</label>
                                    ...
                                    <div class="col-sm-10"><input value="<?php echo $Price; ?>" style="width:450px" type="number" step="any" name="Price" min="0" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
