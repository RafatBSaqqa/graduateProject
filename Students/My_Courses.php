									...
									<div class="dashboard_container">
										<div class="dashboard_container_header">
											<div class="dashboard_fl_1">
												<h4>View My Pending Courses List</h4>
											</div>
										</div>
											...
											<div class="table-responsive">
												<table class="table">
													...
													<tbody>
														...
														<?php
					$sql1 = mysqli_query($dbConn,"select * from subscriptions where Student_ID='$S_ID' AND Status='Pending'");
...
<td>
																<div class="dash_action_link">
																	<a href="Course_Details.php?Course_ID=<?php echo $Course_ID; ?>" style="color:#fff" class="btn btn-theme">View</a>
																</div>	
															</td>
					...
					?>
									...
									<div class="dashboard_container">
										<div class="dashboard_container_header">
											<div class="dashboard_fl_1">
												<h4>View My Finished Courses List</h4>
											</div>
										</div>
										<div class="dashboard_container_body">
											<div class="table-responsive">
												<table class="table">
													...
													<tbody>
														...
														<?php
					$sql1 = mysqli_query($dbConn,"select * from subscriptions where Student_ID='$S_ID' AND Status='Finished'");
					while ($row1 = mysqli_fetch_array($sql1)){
