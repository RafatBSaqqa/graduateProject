            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Instructors List Information</h5>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from instructors order by ID DESC");
...
{location.replace('Delete_Instructor.php?Instructor_ID=<?php echo $Instructor_ID; ?>')}" class="btn btn-primary btn-sm" role="button">Delete</a><br>  <a href="Edit_Instructor.php?Instructor_ID=<?php echo $Instructor_ID; ?>" style="width:52px" class="btn btn-primary btn-sm" role="button">Edit</a></center></td>
 </tr>
