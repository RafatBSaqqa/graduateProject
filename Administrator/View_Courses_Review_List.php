...
<body style="back">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Courses Review List Information</h5>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from courses_rates order by ID DESC");
					...
					$sql2 = mysqli_query($dbConn,"select * from courses where ID='$Course_ID'");
					$row2 = mysqli_fetch_array($sql2);
					$C_Title = $row2['Title'];



					$sql3 = mysqli_query($dbConn,"select * from students where ID='$Student_ID'");
					$row3 = mysqli_fetch_array($sql3);
					$S_Full_Name = $row3['Full_Name'];
 ...
 <a href="JavaScript:if(confirm('Are You Sure To Accept This Review ?')==true)
{location.replace('Accept_Review.php?CR_ID=<?php echo $CR_ID; ?>')}" class="btn btn-primary btn-sm" role="button">Accept</a>
...
<br>
 ...
 <a href="JavaScript:if(confirm('Are You Sure To Delete This Review ?')==true)
{location.replace('Delete_Review.php?CR_ID=<?php echo $CR_ID; ?>')}" class="btn btn-primary btn-sm" role="button">Delete</a>
