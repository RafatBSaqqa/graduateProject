...
$sql1 = mysqli_query($dbConn,"select * from instructors where ID='$Instructor_ID'");
...
$sql1 = mysqli_query($dbConn,"update instructors set Status='$Status' where ID='$Instructor_ID'");
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Edit_Instructor.php?Instructor_ID=<?php echo $Instructor_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
