...
$sql1 = mysqli_query($dbConn,"select * from students where ID='$Student_ID'");
...
$sql1 = mysqli_query($dbConn,"update students set Status='$Status' where ID='$Student_ID'");
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Edit_Student.php?Student_ID=<?php echo $Student_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
