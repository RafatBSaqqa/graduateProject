...
$insert = mysqli_query($dbConn,"insert into instructors (Full_Name,Username,Password,Status) values ('$Full_Name','$Username','$Password','$Status')");
                    ...
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Add_New_Instructor.php" class="form-horizontal" enctype="multipart/form-data">
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Full Name *</label>
                                    ...
                                    <div class="col-sm-10"><input value="" style="width:450px" type="text" name="Full_Name" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Username *</label>
                                    ...
                                    <div class="col-sm-10"><input value="" style="width:450px" type="text" name="Username" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
								...
								<div class="form-group"><label class="col-sm-2 control-label">Password *</label>
                                    ...
                                    <div class="col-sm-10"><input value="" style="width:450px" type="password" name="Password" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
