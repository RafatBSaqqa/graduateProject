            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Students List Information</h5>
...
{location.replace('Delete_Student.php?Student_ID=<?php echo $Student_ID; ?>')}" class="btn btn-primary btn-sm" role="button">Delete</a><br>  <a href="Edit_Student.php?Student_ID=<?php echo $Student_ID; ?>" style="width:52px" class="btn btn-primary btn-sm" role="button">Edit</a></center></td>
 </tr>
